...
if(isset($_GET['Ml_Config'])){
    ...
    if ($query != 0) {
        header('Location: https://auth.mercadolibre.com/authorization?response_type=code&client_id='.$data['appid'].'&redirect_uri='.ConfigPainel('base_url').'ecommerce.php?MercadoLivre');
    } else {
